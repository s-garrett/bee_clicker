    ...
    return (<main className="Home">
      ...
      <div className="proj-container">
        <div className="single_game">
          ...
          <UnityGame name="Pick Up" linker="https://github.com/s-garrett/VMS_unity/tree/master/final_proj" paragraph={pickupDesc}/>
        </div>
        <div className="single_game">
          <img className="images" src={img_bee_clicker} alt=""/>
          <UnityGame name="Bee Clicker" linker="https://github.com/s-garrett/VMS_unity/tree/master/clicker_game_proj3" paragraph={beeClickerDesc}/>
        </div>
      </div>
